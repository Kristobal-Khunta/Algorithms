...
# чем предполагалось ранними исследованиями.
...
# Письменность Майя основывается на маленьких рисунках,
# известных как значки, которые обозначают звуки.
...
# но не знают все возможные способы их расположения.
...
# которую они изучают, в порядке их появления.
...
# подсчитывает количество всех возможных вхождений слова W в S,
...
matchingLetters = matchDict(wDict, sDict)
occurrences = 0
