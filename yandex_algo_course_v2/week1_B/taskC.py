...
# Системный администратор поменял дату на одном из бэкапов и
# сейчас хочет вернуть дату обратно. Но он не проверил,
...
# Гарантируется, что хотя бы в одном формате запись xyz
...
if __name__ == "__main__":
    ...
    if x == y:
        ## 3 3 2021 одинаково, для обоих календарей. Определяется однозначно.
        print(1)
    elif x <= 12 and y <= 12:
        print(0)
    else:
